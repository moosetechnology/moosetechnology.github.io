...
In order to only showcase the transformation operations here and not go over what is shown in the three blog posts on code transformation, the only repository to import in your Moose image is `FAST-Java-Tools` :
