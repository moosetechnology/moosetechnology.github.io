...
:::tip[Tip]
You can directly load the C metamodel from the Moose toolbar by going to the **Library** menu: _Library Famix > Load additional modules > Load Famix-Cpp_
:::
...
- [Creating an importer for an alien grammar](https://modularmoose.org/blog/2025-03-26-visitor-external-grammar/)
