...
To do so, we will use the [submetamodels feature](/developers/create-new-metamodel#introducing-submetamodels) of the generator.
...
![World meta-model](./img/posts/2021-05-15-connecting-meta-models/world-meta-model.drawio.svg)
...
![Connected meta-model](./img/posts/2021-05-15-connecting-meta-models/connected-meta-model.drawio.svg)
...
If you need more control on the generated entities (*e.g.*, name of the relations, *etc.*), please have a look at the [create meta-model wiki page](/developers/create-new-metamodel).
