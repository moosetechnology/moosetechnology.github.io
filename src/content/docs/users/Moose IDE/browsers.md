...
![Moose toolbar](./img/moose-bar.png)
...
![Moose Overview IDE](./img/moose-overview-ide.png)

### Opening Browser

To open a browser, select in the menu the browser you want to open.

![Opening Browser](./img/openning-browser.png)
...
![Open in page](./img/open-in-page.png)
...
![Not In MooseIDE](https://img.shields.io/badge/-Not%20In%20MooseIDE-yellow)
...
![Moose Playground](./img/moose-playground.png)
